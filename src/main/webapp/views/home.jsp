            ...
            <div class="banner">
               <ul>
                  <li data-transition="fade" data-slotamount="7" class="slide" data-slide='Rush.'>
                     <!-- <img alt='' src="resources/images/banners/07-talltales-la_1520834070830.jpg"> -->
                  ...
                  <li data-transition="fade" data-slotamount="7" class="slide fading-slide" data-slide='Travel worldwide.
                     Create trip film.'>
                     <!-- <img alt='' src="resources/images/banners/300_1517827517048.jpg"> -->
                     <div class="caption slide__video" data-x="0" data-y="0" data-autoplay='true'>
                        <video class="media-element"  autoplay="autoplay" preload='none' loop="loop" muted="" src="resources/video/53170154.mp4" >
                           <source type="video/webm" src="resources/video/53170154.webm">
                           <source type="video/mp4" src="resources/video/53170154.mp4">
                           <source type="video/ogg" src="resources/video/53170154.ogv">
                        </video>
                     </div>
               ...
               <div class="col-sm-12 change--col">
                  <div class="movie-beta__item ">
                     ...
                     <ul class="movie-beta__info">
                        ...
                        <li class="last-block">
                           <a href="movie-page-left" class="slide__link">more</a>
                        </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-sm-8 col-md-9">
                     ...
                     <div class="movie movie--test movie--test--dark movie--test--left">
                        ...
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">Gravity (2013)  </a>
                     ...
                     <div class="movie movie--test movie--test--light movie--test--left">
                        ...
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">The Hobbit: The Desolation of Smaug (2013)  </a>
                           <p class="movie__time">169 min</p>
                     ...
                     <div class="movie movie--test movie--test--light movie--test--right">
                        ...
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">The Hunger Games: Catching Fire (2013)   </a>
                     ...
                     <div class="movie movie--test movie--test--dark movie--test--right">
                        ...
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">Thor: The Dark World (2013) </a>
                     ...
                     <div class="movie movie--test movie--test--dark movie--test--left">
                        <div class="movie__images">
                           <a href="movie-page-left" class="movie-beta__link">
                           <img alt='' src="resources/images/cinema/braven1_1521447831332.jpg">
                           </a>
                        </div>
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">World War Z (2013)  </a>
                     ...
                     <div class="movie movie--test movie--test--light movie--test--left">
                        <div class="movie__images">
                           <a href="movie-page-left" class="movie-beta__link">
                           <img alt='' src="resources/images/cinema/charming_1521451504008.jpg">
                           </a>
                        </div>
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">Prisoners (2013) </a>
                     ...
                     <div class="movie movie--test movie--test--light movie--test--right">
                        <div class="movie__images">
                           <a href="movie-page-left" class="movie-beta__link">
                           <img alt='' src="resources/images/cinema/christopherrobin3_1521003377952.jpg">
                           </a>
                        </div>
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">This Is the End (2013)   </a>
                     ...
                     <div class="movie movie--test movie--test--dark movie--test--right">
                        <div class="movie__images">
                           <a href="movie-page-left" class="movie-beta__link">
                           <img alt='' src="resources/images/cinema/fa-official-final_1521425877691.jpg">
                           </a>
                        </div>
                        <div class="movie__info">
                           <a href='movie-page-left' class="movie__title">The Internship (2013)  </a>
                           <p class="movie__time">112 min</p>
                  ...
                  <aside class="col-sm-4 col-md-3">
                     <div class="sitebar first-banner--left">
                        <div class="banner-wrap first-banner--left">
                           <img alt='banner' src="resources/images/cinema/ploey-bay-di-dung-so-2_1521690282861.JPG">
                        </div>
                        <div class="banner-wrap">
                           <img alt='banner' src="resources/images/cinema/teaser-ba-chang-khuyet_1521449380094.jpg">
                        </div>
                        <div class="banner-wrap banner-wrap--last">
                           <img alt='banner' src="resources/images/cinema/xmen_1519696633757.jpg">
                        </div>
               ...
               <div class="col-sm-4 similar-wrap col--remove">
                  <div class="post post--preview post--preview--wide">
                     <div class="post__image">
                        <img alt='' src="resources/images/cinema/5_1519884973526.jpg">
                     ...
                     <p class="post__date">22 December 2017 </p>
                     <a href="single-page-left" class="post__title">[Review] Tháng Năm Rực Rỡ: Phim Việt Remake Xuất Sắc Nhất Từ Trước Đến Nay?</a>
                     <a href="single-page-left" class="btn read-more post--btn">read more</a>
                  </div>
               </div>
               <div class="col-sm-4 similar-wrap col--remove">
                  <div class="post post--preview post--preview--wide">
                     <div class="post__image">
                        <img alt='' src="resources/images/cinema/1_1519357482700.jpg">
                        <div class="social social--position social--hide">
                           <span class="social__name">Share:</span>
                           <a href='#' class="social__variant social--first fa fa-facebook"></a>
                           <a href='#' class="social__variant social--second fa fa-twitter"></a>
                     ...
                     <p class="post__date">22 January 2018 </p>
                     <a href="single-page-left" class="post__title">[Review] Black Panther: Mở Màn Hoàn Hảo Cho Infinity War</a>
                     <a href="single-page-left" class="btn read-more post--btn">read more</a>
                  </div>
               </div>
               <div class="col-sm-4 similar-wrap col--remove">
                  <div class="post post--preview post--preview--wide">
                     <div class="post__image">
                        <img alt='' src="resources/images/cinema/450_1518427087389.jpg">
                        <div class="social social--position social--hide">
                           <span class="social__name">Share:</span>
                           <a href='#' class="social__variant social--first fa fa-facebook"></a>
                           <a href='#' class="social__variant social--second fa fa-twitter"></a>
                     ...
                     <p class="post__date">1 March 2018 </p>
                     <a href="single-page-left" class="post__title">[Review] 798Mười: Không Thua Bom Tấn Châu Tinh Trì?</a>
                     <a href="single-page-left" class="btn read-more post--btn">read more</a>
                  </div>
               </div>
            </div>
